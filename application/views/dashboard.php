			...
			<div class="panel-heading">
				...
				<div class="panel-options">
					<ul class="nav nav-tabs">
						<li class=""><a href="#area-chart" data-toggle="tab">Ugly Graph</a></li>
						<li class="active"><a href="#line-chart" data-toggle="tab">Equally ugly graph</a></li>
						<li class=""><a href="#pie-chart" data-toggle="tab">App Comparison Chart</a></li>
					</ul>
				</div>
			</div>
