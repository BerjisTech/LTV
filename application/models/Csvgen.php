...
class Csvgen extends CI_Model
{
    ...
    function get_user_rows($app_id, $data, $time_start, $time_end)
    {
        ...
        $values[] = "`data_id`, `app_id`, `date`, `event`, `details`, `billing_date`, `shop`, `country`, `email`, `domain`,";
    ...
    private function csvgen(array &$array)
    {
        if (count($array) == 0) {
            return null;
        }
