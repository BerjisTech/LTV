<script>
    ...
    jQuery(document).ready(function($) {
        drawBar('pc_reviews_chart', pc_reviews_data, reviews_keys, reviews_labels, reviews_colors)
        drawBar('icu_reviews_chart', icu_reviews_data, reviews_keys, reviews_labels, reviews_colors)
        drawBar('pon_reviews_chart', pon_reviews_data, reviews_keys, reviews_labels, reviews_colors)
        drawBar('bdn_reviews_chart', bdn_reviews_data, reviews_keys, reviews_labels, reviews_colors)
        drawBar('wpn_reviews_chart', wpn_reviews_data, reviews_keys, reviews_labels, reviews_colors)
        drawBar('tfx_reviews_chart', tfx_reviews_data, reviews_keys, reviews_labels, reviews_colors)
    })
</script>